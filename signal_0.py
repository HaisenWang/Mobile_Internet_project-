...
from numpy_conversions import csv_to_array, as_ndarray
...
def butterworth(signals, sampling_rate, low_pass=None, high_pass=None,
    ...
    if low_pass is not None and high_pass is not None and high_pass >= low_pass:
...
def clean(signals, sessions=None, detrend=True, standardize=True,
    ...
    if sessions is not None:
        ...
        for s in np.unique(sessions):
            ...
            signals[sessions == s, :] = clean(signals[sessions == s],
